...
MODELS = {
    ...
    "meta-llama/Meta-Llama-3.1-8B": ("huggingface", "llama-3.1-8b"),
    "meta-llama/Meta-Llama-3.1-8B-Instruct": ("huggingface", "llama-3.1-8b-instruct"),
    "meta-llama/Meta-Llama-3.1-70B": ("huggingface", "llama-3.1-70b"),
    "meta-llama/Meta-Llama-3.1-70B-Instruct": ("huggingface", "llama-3.1-70b-instruct"),
    "meta-llama/Meta-Llama-3.1-405B": ("huggingface", "llama-3.1-405b"),
    "meta-llama/Meta-Llama-3.1-405B-Instruct": ("huggingface", "llama-3.1-405b-instruct"),
    # Mistral
    ...
    "mistralai/Mistral-Nemo-Base-2407": ("huggingface", "mistral-nemo"),
    "mistralai/Mistral-Nemo-Instruct-2407": ("huggingface", "mistral-nemo-instruct"),
    "mistralai/Mistral-Large-Instruct-2407": ("huggingface", "mistral-large-instruct"),
    # Gemma
    ...
    "google/gemma-2-2b": ("huggingface", "gemma-2-2b"),
    "google/gemma-2-2b-it": ("huggingface", "gemma-2-2b-instruct"),
    ...
    "microsoft/Phi-3-small-8k-instruct": ("huggingface", "phi-3-small-instruct"),
