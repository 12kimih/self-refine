...
class AcronymTemplate(BaseTemplate):
    ...
    feedback_instruction: str = "Provide detailed feedback of two or more sentences for each of the following four evaluation criteria: relevance to the title, ease of pronunciation, ease of spelling, familiarity. " "Assign a score out of 10 points for each criterion.\n\n"
    feedback_query: str = "Feedback:\n"
    feedback_response: str = "Feedback:\n" "* Relevance to the title: {relevance} Score: {relevance_score}/10\n" "* Ease of pronunciation: {pronunciation} Score: {pronunciation_score}/10\n" "* Ease of spelling: {spelling} Score: {spelling_score}/10\n" "* Familiarity: {familiarity} Score: {familiarity_score}/10\n" "Total score: {total_score}/40\n\n"
    feedback_regex: str = r"(?:\*|-) Relevance to the title:\s*(.*?)\s*Score:\s*(\d+)/10\s*\n" r"(?:\*|-) Ease of pronunciation:\s*(.*?)\s*Score:\s*(\d+)/10\s*\n" r"(?:\*|-) Ease of spelling:\s*(.*?)\s*Score:\s*(\d+)/10\s*\n" r"(?:\*|-) Familiarity:\s*(.*?)\s*Score:\s*(\d+)/10\s*(?:\n|$)"
    feedback_output: str = "{n} Feedback:\n" "* Relevance to the title: {relevance} Score: {relevance_score}/10\n" "* Ease of pronunciation: {pronunciation} Score: {pronunciation_score}/10\n" "* Ease of spelling: {spelling} Score: {spelling_score}/10\n" "* Familiarity: {familiarity} Score: {familiarity_score}/10\n" "{n} Total score: {total_score}/40\n"

    refine_context_0: str = "Title: {title}\n\n" "Previous acronym: {acronym}\n" "Feedback:\n" "* Relevance to the title: {relevance} Score: {relevance_score}/10\n" "* Ease of pronunciation: {pronunciation} Score: {pronunciation_score}/10\n" "* Ease of spelling: {spelling} Score: {spelling_score}/10\n" "* Familiarity: {familiarity} Score: {familiarity_score}/10\n" "Total score: {total_score}/40\n\n"
    refine_context_1: str = "Title: {title}\n\nPrevious acronym: {acronym}\n\n"
    refine_context_2: str = "Title: {title}\n\nPrevious acronym: {acronym}\n\n"
    refine_instruction_0: str = "Create an acronym that effectively represents the given title. " "Make sure to create a new acronym distinct from the previous one. " "The new acronym should better align with the four evaluation criteria by incorporating feedback from the previous acronym."
    refine_instruction_1: str = "Create an acronym that effectively represents the given title. " "Make sure to create a new acronym distinct from the previous one. " "The new acronym should better align with the following four evaluation criteria: relevance to the title, ease of pronunciation, ease of spelling, familiarity."
...
class DialogTemplate(BaseTemplate):
    ...
    feedback_instruction: str = "Provide detailed feedback of two or more sentences for each of the following three evaluation criteria: consistency in conversational context and tone, understanding the speaker's intent, sustaining the conversation. " "Assign a score out of 10 points for each criterion.\n\n"
    feedback_query: str = "Feedback:\n"
    ...
    feedback_regex: str = r"(?:\*|-) Consistency in conversational context and tone:\s*(.*?)\s*Score:\s*(\d+)\/10\s*\n" r"(?:\*|-) Understanding the speaker's intent:\s*(.*?)\s*Score:\s*(\d+)\/10\s*\n" r"(?:\*|-) Sustaining the conversation:\s*(.*?)\s*Score:\s*(\d+)\/10\s*(?:\n|$)"
    feedback_output: str = "{n} Feedback:\n" "* Consistency in conversational context and tone: {consistency} Score: {consistency_score}/10\n" "* Understanding the speaker's intent: {understand} Score: {understand_score}/10\n" "* Sustaining the conversation: {sustain} Score: {sustain_score}/10\n" "{n} Total score: {total_score}/30\n"

    refine_context_0: str = "Conversation history:\n{dialog}\n\n" "Previous response: {response}\n" "Feedback:\n" "* Consistency in conversational context and tone: {consistency} Score: {consistency_score}/10\n" "* Understanding the speaker's intent: {understand} Score: {understand_score}/10\n" "* Sustaining the conversation: {sustain} Score: {sustain_score}/10\n" "Total score: {total_score}/30\n\n"
    refine_context_1: str = "Conversation history:\n{dialog}\n\nPrevious response: {response}\n\n"
    refine_context_2: str = "Conversation history:\n{dialog}\n\nPrevious response: {response}\n\n"
    refine_instruction_0: str = "Create a sensible and context-appropriate response for speaker B based on the given conversation history. " "Make sure to create a new response distinct from the previous one. " "The new response should better align with the three evaluation criteria by incorporating feedback from the previous response."
    refine_instruction_1: str = "Create a sensible and context-appropriate response for speaker B based on the given conversation history. " "Make sure to create a new response distinct from the previous one. " "The new response should better align with the following three evaluation criteria: consistency in conversational context and tone, understanding the speaker's intent, sustaining the conversation."
    refine_instruction_2: str = "Create a sensible and context-appropriate response for speaker B based on the given conversation history. " "Make sure to create a new response distinct from the previous one."
    ...
    refine_response_0: str = "New response: {response}\n" "Feedback:\n" "* Consistency in conversational context and tone: {consistency} Score: {consistency_score}/10\n" "* Understanding the speaker's intent: {understand} Score: {understand_score}/10\n" "* Sustaining the conversation: {sustain} Score: {sustain_score}/10\n" "Total score: {total_score}/30\n\n"
...
class MathTemplate(BaseTemplate):
    ...
    feedback_instruction: str = "Provide detailed feedback of two or more sentences for each of the following two evaluation criteria: adequacy of dividing the problem into logical steps, validity of equations. " "Assign a score out of 10 points for each criterion.\n\n"
    feedback_query: str = "Feedback:\n"
    ...
    refine_context_0: str = "Math problem: {question}\n\n" "Previous solution:\n{solution.steps}\n#### {solution.answer}\n" "Feedback:\n" "* Adequacy of dividing the problem into logical steps: {adequacy} Score: {adequacy_score}/10\n" "* Validity of equations: {validity} Score: {validity_score}/10\n" "Total score: {total_score}/20\n\n"
    refine_context_1: str = "Math problem: {question}\n\nPrevious solution:\n{solution.steps}\n#### {solution.answer}\n\n"
    refine_context_2: str = "Math problem: {question}\n\nPrevious solution:\n{solution.steps}\n#### {solution.answer}\n\n"
    refine_instruction_0: str = "Create a detailed solution for the given math problem. " "Make sure to create a new solution distinct from the previous one. " "The new solution should better align with the two evaluation criteria by incorporating feedback from the previous solution."
    refine_instruction_1: str = "Create a detailed solution for the given math problem. " "Make sure to create a new solution distinct from the previous one. " "The new solution should better align with the following two evaluation criteria: adequacy of dividing the problem into logical steps, validity of equations."
...
class SentenceTemplate(BaseTemplate):
    ...
    feedback_instruction: str = "Provide detailed feedback of two or more sentences for each of the following two evaluation criteria: inclusion of the concepts, logical coherence. " "Assign a score out of 10 points for each criterion.\n\n"
    feedback_query: str = "Feedback:\n"
    ...
    refine_context_0: str = "Concepts: {concepts}\n\n" "Previous sentence: {sentence}\n" "Feedback:\n" "* Inclusion of the concepts: {inclusion} Score: {inclusion_score}/10\n" "* Logical coherence: {logical} Score: {logical_score}/10\n" "Total score: {total_score}/20\n\n"
    refine_context_1: str = "Concepts: {concepts}\n\nPrevious sentence: {sentence}\n\n"
    refine_context_2: str = "Concepts: {concepts}\n\nPrevious sentence: {sentence}\n\n"
    refine_instruction_0: str = "Create a sentence that incorporates as many given concepts as possible within the bounds of logical coherence. " "Make sure to create a new sentence distinct from the previous one. " "The new sentence should better align with the two evaluation criteria by incorporating feedback from the previous sentence."
    refine_instruction_1: str = "Create a sentence that incorporates as many given concepts as possible within the bounds of logical coherence. " "Make sure to create a new sentence distinct from the previous one. " "The new sentence should better align with the following two evaluation criteria: inclusion of the concepts, logical coherence."
    refine_instruction_2: str = "Create a sentence that incorporates as many given concepts as possible within the bounds of logical coherence. " "Make sure to create a new sentence distinct from the previous one."
    ...
    refine_response_0: str = "New sentence: {sentence}\n" "Feedback:\n" "* Inclusion of the concepts: {inclusion} Score: {inclusion_score}/10\n" "* Logical coherence: {logical} Score: {logical_score}/10\n" "Total score: {total_score}/20\n\n"
...
class SentimentTemplate(BaseTemplate):
    ...
    feedback_instruction: str = "Provide detailed feedback of two or more sentences for each of the following two evaluation criteria: effectiveness of sentiment reversal, logical coherence. " "Assign a score out of 10 points for each criterion.\n\n"
    feedback_query: str = "Feedback:\n"
    ...
    refine_context_0: str = "Review: {review}\n\n" "Previous reversed review: {reversed_review}\n" "Feedback:\n" "* Effectiveness of sentiment reversal: {effective} Score: {effective_score}/10\n" "* Logical coherence: {logical} Score: {logical_score}/10\n" "Total score: {total_score}/20\n\n"
    refine_context_1: str = "Review: {review}\n\nPrevious reversed review: {reversed_review}\n\n"
    refine_context_2: str = "Review: {review}\n\nPrevious reversed review: {reversed_review}\n\n"
    refine_instruction_0: str = "Create a reversed review that conveys the opposite sentiment of the given review. " "Make sure to create a new reversed review distinct from the previous one. " "The new reversed review should better align with the two evaluation criteria by incorporating feedback from the previous reversed review."
    refine_instruction_1: str = "Create a reversed review that conveys the opposite sentiment of the given review. " "Make sure to create a new reversed review distinct from the previous one. " "The new reversed review should better align with the following two evaluation criteria: effectiveness of sentiment reversal, logical coherence."
    ...
    refine_response_0: str = "New reversed review: {reversed_review}\n" "Feedback:\n" "* Effectiveness of sentiment reversal: {effective} Score: {effective_score}/10\n" "* Logical coherence: {logical} Score: {logical_score}/10\n" "Total score: {total_score}/20\n\n"
